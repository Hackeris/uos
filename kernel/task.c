...
int init_tasks() {
	...
	gdt_set_descriptor(SELECTOR_TSS >> 3, (uint32_t) &_tss, sizeof(tss) - 1,
			I86_GDT_DESC_EXEC_CODE | I86_GDT_DESC_ACCESS | I86_GDT_DESC_MEMORY
					| I86_GDT_DESC_DPL1, I86_GDT_GRAND_LIMITHI_MASK);
	//	for ldt
	gdt_set_descriptor(SELECTOR_FIRST_LDT >> 3, (uint32_t) &proc_table[0].ldts,
			2 * sizeof(ldt_descriptor) - 1,
			I86_GDT_DESC_READWRITE | I86_GDT_DESC_MEMORY | I86_GDT_DESC_DPL1,
...
int init_proc() {
	...
	ldt_set_descriptor(&p_proc->ldts[1], 0, 0xffffffff,
			I86_GDT_DESC_READWRITE | I86_GDT_DESC_CODEDATA | I86_GDT_DESC_MEMORY
					| I86_GDT_DESC_DPL1,
			I86_GDT_GRAND_4K | I86_GDT_GRAND_32BIT | I86_GDT_GRAND_LIMITHI_MASK);
	p_proc->regs.cs = 0 | SELECTOR_LDT_MASK | 1;
	p_proc->regs.ds = 8 | SELECTOR_LDT_MASK | 1;
	p_proc->regs.es = 8 | SELECTOR_LDT_MASK | 1;
	p_proc->regs.fs = 8 | SELECTOR_LDT_MASK | 1;
	p_proc->regs.gs = 8 | SELECTOR_LDT_MASK | 1;
